module.exports = function(params){
  ...
  this.orOperator = (typeof params.orOperator === 'boolean') ? params.orOperator : false;
  this.andOrOperator = (typeof params.andOrOperator === 'boolean') ? params.andOrOperator : false;
  ...
  if (this.siteContext && this.siteContext !== 'web'){
    this.BASE_LIST_URL = '/sites/' + this.siteContext + this.BASE_LIST_URL;
  }
this.BASE_CURRENTUSER = '/_api/web/currentuser';
console.log(this.BASE_CURRENTUSER);
  return {
