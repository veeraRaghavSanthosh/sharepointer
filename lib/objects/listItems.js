  ...
  var doRequest = require('../util/doRequest')(client),
    ...
    crudl = {
      ...
      byteStream: function(floderName, filename, cb) {
        var host = "/sites/Training2/TestITCARApprovals/_api/web/GetFolderByServerRelativeUrl('"+floderName+"')/Files('"+filename+"')/$value";

        console.log("in the sharepoint npm byteStream function--host",host);
