...
module.exports = function(client) {
  ...
  var crudl = {
    currentuser: function(filter, cb) {
      var baseString = client.BASE_LIST_URL.substring(0,client.BASE_LIST_URL.indexOf('_api/')) 
      var host = baseString + "/web/currentuser?$filter="+filter;
  ...
  crudl.currentuser = crudl.currentuser;
